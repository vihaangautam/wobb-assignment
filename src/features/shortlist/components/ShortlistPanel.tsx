            ...
            <ul className="space-y-3 list-none p-0 m-0">
              {profiles.map((profile) => (
                <li
                  ...
                  className="flex items-center gap-3.5 p-3.5 rounded-2xl border border-gray-100 dark:border-dark-200 bg-white dark:bg-dark-100 hover:bg-gray-50 dark:hover:bg-dark-200/50 transition-all duration-200 group"
                >
                  <img
                    src={profile.avatarUrl}
                    alt={`${profile.fullName}'s profile photo`}
                    className="w-11 h-11 rounded-full object-cover border border-gray-100 dark:border-dark-300"
                    loading="lazy"
                  />
