...
export function ProfileDetailPage() {
  ...
  if (!username) {
    return (
      <Layout>
        <div className="max-w-md mx-auto text-center py-16 bg-white dark:bg-dark-50 border border-gray-150 rounded-3xl p-8 shadow-sm">
          ...
          <Link
            to="/"
            className="gofundme-btn gofundme-btn-primary rounded-full"
          >
            <ArrowLeft size={16} />
    ...
    return (
      <Layout>
        <div className="max-w-5xl mx-auto flex flex-col gap-8 py-4">
          ...
          <div className="h-5 w-28 bg-gray-200 dark:bg-dark-300 rounded-full animate-pulse" />
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            {/* Left panel placeholder */}
            <div className="bg-white dark:bg-dark-50 border border-gray-100 dark:border-dark-300 rounded-3xl p-6 shadow-sm flex flex-col items-center gap-4 animate-pulse">
              ...
              <div className="h-16 w-full bg-gray-100 dark:bg-dark-200 rounded-2xl" />
              <div className="h-10 w-full bg-gray-200 dark:bg-dark-300 rounded-full" />
              <div className="h-10 w-full bg-gray-200 dark:bg-dark-300 rounded-full" />
            </div>
            ...
            <div className="lg:col-span-2 flex flex-col gap-4 animate-pulse">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="bg-white dark:bg-dark-50 border border-gray-100 dark:border-dark-300 p-5 rounded-3xl shadow-sm flex gap-4">
                    <div className="w-12 h-12 bg-gray-200 dark:bg-dark-300 rounded-2xl flex-shrink-0" />
    ...
    <Layout>
      <div className="max-w-5xl mx-auto animate-fade-in">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-semibold text-gray-500 dark:text-gray-400 hover:text-accent mb-8 transition-colors duration-200 group"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="gofundme-card p-6 text-center flex flex-col items-center">
            
            {/* Avatar with Ring */}
            <div className="relative mb-6">
              {imgError ? (
                <div className="w-28 h-28 rounded-full bg-accent-light text-accent flex items-center justify-center font-bold text-3xl border border-accent/20 shadow-sm ring-4 ring-accent/15">
                ...
                <img
                  ...
                  className="w-28 h-28 rounded-full object-cover border-2 border-white dark:border-dark-50 shadow-sm ring-4 ring-accent/15"
                />
              )}
              <span className={clsx(
            ...
            {/* Names */}
            <h2 className="text-2xl font-extrabold text-h tracking-tight mb-1 flex items-center justify-center gap-1.5">
            ...
            <div className="flex flex-col gap-3 w-full">
              ...
              {user.url && (
                <a
                  ...
                  className="gofundme-btn rounded-full w-full px-4 py-2.5 text-sm hover:border-accent hover:text-accent"
                >
          ...
          <div className="lg:col-span-2">
            <h3 className="text-lg font-bold text-h tracking-tight mb-5 flex items-center gap-2">
            ...
            {user.stat_history && user.stat_history.length > 0 && (
              <div className="mt-8 gofundme-card p-6 text-left">
                <h3 className="text-lg font-bold text-h tracking-tight mb-4 flex items-center gap-2">
